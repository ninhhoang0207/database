...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2017 at 12:33 PM
...
DROP TABLE IF EXISTS `nguoidung_khuyenmai`;
...
DROP TABLE IF EXISTS `nhanghi_dichvu`;
...
DROP TABLE IF EXISTS `nhanghi_giatien`;
...
DROP TABLE IF EXISTS `nhanghi_hinhanh`;
